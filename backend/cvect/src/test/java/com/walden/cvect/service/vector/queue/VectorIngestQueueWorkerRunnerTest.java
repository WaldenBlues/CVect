...
@DisplayName("VectorIngestQueueWorkerRunner unit tests")
class VectorIngestQueueWorkerRunnerTest {

    @Mock
    private VectorIngestQueueWorkerService workerService;
    ...
    void stopShouldLetQueuedWorkersExitBeforeInitialDelayWhenShutdownWinsRace() throws Exception {
        ...
        VectorIngestQueueWorkerRunner runner = new VectorIngestQueueWorkerRunner(
                workerService,
                taskExecutor,
                10_000L,
                10_000L,
