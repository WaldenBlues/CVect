...
export CVECT_STORAGE_TYPE="local"
export CVECT_STORAGE_LOCAL_ROOT="/tmp/cvect-storage"
...
assert_contains "${NOHUP_LOG}" "MAX_INPUT_LENGTH=2048"
assert_contains "${NOHUP_LOG}" "CVECT_EMBEDDING_TIMEOUT_SECONDS=321"
assert_contains "${NOHUP_LOG}" "CVECT_STORAGE_TYPE=local"
assert_contains "${NOHUP_LOG}" "CVECT_STORAGE_LOCAL_ROOT=/tmp/cvect-storage"
